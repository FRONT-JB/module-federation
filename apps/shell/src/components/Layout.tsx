    ...
    <div>
      <header className="global-nav">
        <div className="global-nav-content">
          <NavLink className="global-nav-logo" to={routePath.Root}>
            <svg
              data-v-62b4fdfc=""
              width="30"
              height="30"
          ...
          <nav className="global-nav-nav">
            <ul className="global-nav-items">
              <li className="global-nav-item">
                <NavLink className="global-nav-link" to={routePath.Posting}>
                  <Icon.Home />
                  <span className="global-nav-link-text">Home</span>
                </NavLink>
              </li>

              <li className="global-nav-item">
                <NavLink className="global-nav-link" to={routePath.Network}>
                  <Icon.UserFriends />
              ...
              <li className="global-nav-item">
                <NavLink className="global-nav-link" to={routePath.Edu}>
                  <Icon.LaptopCode />
              ...
              <li className="global-nav-item">
                <NavLink className="global-nav-link" to={routePath.Job}>
                  <Icon.Briefcase />
